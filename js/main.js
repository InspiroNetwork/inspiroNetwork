...
function initializeCalculatorForms() {
    ...
    natalChartForm.addEventListener("submit", (e) => {
      ...
      if (previewPlaceholder) {
        previewPlaceholder.innerHTML =
          '<div class="loading-spinner"><i class="fas fa-spinner fa-spin"></i></div><p class="text-center">Calculating your chart...</p>'
      }
  ...
  if (humanDesignForm) {
    ...
    // Handle form submission (simulated)
    humanDesignForm.addEventListener("submit", (e) => {
      e.preventDefault()
      ...
      if (previewPlaceholder) {
        previewPlaceholder.innerHTML =
          '<div class="loading-spinner"><i class="fas fa-spinner fa-spin"></i></div><p class="text-center">Calculating your Human Design...</p>'
      }
