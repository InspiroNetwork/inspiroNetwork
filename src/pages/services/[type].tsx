...
const ServiceTypeData: Record<string, { title: string; description: string; color: string; icon: string }> = {
  coaching: {
    title: "Life Coaching",
    description:
      "Transformative sessions to clarify your vision, overcome obstacles, and create an action plan aligned with your higher purpose.",
    color: "#3b82f6",
    icon: "👥",
  },
  astrologia: {
    title: "Astrología",
    description:
      "Discover the cosmic patterns in your natal chart that reveal your strengths, challenges, and life purpose.",
    color: "#9333ea",
    icon: "⭐",
  },
  "diseno-humano": {
    title: "Diseño Humano",
    description:
      "Unlock your energetic type, authority, and strategy for decision-making aligned with your unique design.",
    color: "#f59e0b",
    icon: "🧬",
  },
  constelaciones: {
    ...
    description:
      "Reveal and heal hidden systemic patterns in your family or organizational system that affect your life.",
    color: "#6366f1",
    icon: "🔄",
  },
  sanaciones: {
    title: "Sanaciones",
    description:
      "Experience deep energetic healing that addresses the root causes of physical, emotional, and spiritual imbalances.",
    color: "#14b8a6",
    icon: "💫",
  },
  retiros: {
      ...
      <main className="pt-20 pb-16">
        ...
        <section className="relative py-20 px-4 overflow-hidden">
          ...
          <div className="container mx-auto z-10 text-center max-w-4xl relative">
            ...
            <p className="text-lg text-violet-300 mb-8">{serviceInfo.description}</p>
            <Link href="/services" className="inline-flex items-center text-violet-300 hover:text-white transition">
              ...
              {isLoading ? (
                ...
                Array(6)
                  ...
                  .map((_, i) => (
                    <div
                      key={i}
                      className="bg-indigo-900/50 backdrop-blur-sm rounded-xl overflow-hidden shadow-lg border border-indigo-500/30 p-6"
                    >
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
              <div className="bg-indigo-900/50 backdrop-blur-sm rounded-xl p-6 border border-indigo-500/20">
                ...
                <p className="text-violet-300">
                  Gain profound insights into your life path and purpose, clearing confusion and indecision.
                </p>
              </div>
              ...
              <div className="bg-indigo-900/50 backdrop-blur-sm rounded-xl p-6 border border-indigo-500/20">
                ...
                <p className="text-violet-300">
                  Release emotional blockages and transform negative patterns into sources of strength.
                </p>
              </div>
              ...
              <div className="bg-indigo-900/50 backdrop-blur-sm rounded-xl p-6 border border-indigo-500/20">
                ...
                <p className="text-violet-300">
                  Discover your innate strengths and learn to make decisions aligned with your authentic self.
                </p>
              </div>
              ...
              <div className="bg-indigo-900/50 backdrop-blur-sm rounded-xl p-6 border border-indigo-500/20">
                ...
                <p className="text-violet-300">
                  Enhance your relationships with others by first understanding and honoring your own nature.
                </p>
              </div>
            </div>
          </div>
        ...
        <section className="py-20 px-4">
          <div className="container mx-auto max-w-6xl">
            <h2 className="text-3xl md:text-4xl font-montserrat font-bold mb-12 text-center">What Our Clients Say</h2>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
              <div className="bg-indigo-900/30 backdrop-blur-sm rounded-xl p-6 shadow-lg border border-indigo-500/20">
                <p className="text-violet-200 italic mb-6">
                  "My session completely transformed how I see myself and my path forward. I gained clarity on issues
                  I've been struggling with for years and now have practical tools to implement daily."
                </p>
              ...
              <div className="bg-indigo-900/30 backdrop-blur-sm rounded-xl p-6 shadow-lg border border-indigo-500/20">
                <p className="text-violet-200 italic mb-6">
                  "The insights I received were incredibly accurate and helpful. It's like having a cosmic map that
                  helps me navigate life's challenges with more awareness and confidence."
                </p>
                <div className="flex items-center">
                  <img
        ...
        <section className="py-20 px-4 relative overflow-hidden">
          ...
          <div className="container mx-auto max-w-3xl relative z-10">
            <div className="bg-indigo-900/50 backdrop-blur-md rounded-xl p-8 md:p-12 border border-indigo-500/30">
              <h2 className="text-2xl md:text-3xl font-montserrat font-bold mb-4 text-center">
