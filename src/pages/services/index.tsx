    ...
    <div className="cosmic-bg font-poppins text-white overflow-x-hidden min-h-screen">
      ...
      <main className="pt-20 pb-16">
          ...
          <div className="container mx-auto max-w-6xl">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mt-12">
              <div className="text-center">
                <div className="w-16 h-16 rounded-full bg-indigo-600 flex items-center justify-center mx-auto mb-4 text-white text-xl font-bold">
                  1
                </div>
                <h3 className="text-xl font-montserrat font-semibold mb-3">Choose Your Service</h3>
                <p className="text-violet-300">
                  Browse our range of spiritual and transformative services to find the perfect match for your needs.
                </p>
              </div>
              <div className="text-center">
                <div className="w-16 h-16 rounded-full bg-indigo-600 flex items-center justify-center mx-auto mb-4 text-white text-xl font-bold">
                ...
                <p className="text-violet-300">
                  Select a convenient date and time for your session with one of our expert practitioners.
                </p>
              </div>
              <div className="text-center">
                <div className="w-16 h-16 rounded-full bg-indigo-600 flex items-center justify-center mx-auto mb-4 text-white text-xl font-bold">
                ...
                <p className="text-violet-300">
                  Experience deep transformation as you connect with cosmic wisdom tailored to your unique journey.
                </p>
              </div>
            </div>
          </div>
        ...
        <section className="py-20 px-4 bg-indigo-900/30 backdrop-blur-sm">
          <div className="container mx-auto max-w-6xl">
            <h2 className="text-3xl md:text-4xl font-montserrat font-bold mb-6 text-center">
              Our Expert Practitioners
            </h2>
            <p className="text-center text-violet-300 max-w-3xl mx-auto mb-12">
              Meet our team of skilled practitioners who bring decades of combined experience in spiritual guidance,
              astrology, and holistic healing.
            </p>
              ...
              {isLoading ? (
                ...
                Array(3)
                  ...
                  .map((_, i) => (
                    <div
                      key={i}
                      className="bg-indigo-900/50 backdrop-blur-sm rounded-xl overflow-hidden border border-indigo-500/20"
                    >
                ...
                <>
                  <div className="bg-indigo-900/50 backdrop-blur-sm rounded-xl overflow-hidden border border-indigo-500/20">
                    ...
                    <div className="p-6">
                      ...
                      <p className="text-violet-300 text-sm">
                        With over 15 years of experience in astrology and 8 years in Human Design, Elena provides
                        profound insights into your cosmic blueprint.
                      </p>
                    </div>
                  </div>
                  ...
                  <div className="bg-indigo-900/50 backdrop-blur-sm rounded-xl overflow-hidden border border-indigo-500/20">
                    ...
                    <div className="p-6">
                      ...
                      <p className="text-violet-300 text-sm">
                        A certified life coach and meditation instructor who specializes in helping clients align with
                  ...
                  <div className="bg-indigo-900/50 backdrop-blur-sm rounded-xl overflow-hidden border border-indigo-500/20">
                    ...
                    <div className="p-6">
                      ...
                      <p className="text-violet-300 text-sm">
                        A gifted energy healer who facilitates transformative healing sessions and leads our spiritual
  ...
  return (
    <button
      ...
      className={`px-4 py-2 rounded-full text-sm font-medium transition-all ${
        isActive ? `${color} text-white` : "bg-indigo-900/50 text-white hover:bg-indigo-800/70"
      }`}
    >
      {label}
    </button>
