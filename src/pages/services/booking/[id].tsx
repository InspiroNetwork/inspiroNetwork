...
import { type Service, BookingSchema } from "@shared/schema"
...
const ServiceBooking = () => {
  ...
  const form = useForm<FormValues>({
    ...
    defaultValues: {
      ...
      timeSlot: "",
      message: "",
      serviceId: Number.parseInt(id || "0"),
              ...
              <div className="bg-indigo-900/30 backdrop-blur-sm rounded-xl p-6 md:p-8 border border-indigo-500/20">
                ...
                <Form {...form}>
                  <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-6">
                            ...
                            <Popover>
                              <PopoverTrigger asChild>
                                <FormControl>
                                  ...
                                  >
                                    {field.value ? format(field.value, "PPP") : <span>{t("booking.selectDate")}</span>}
                    ...
                    {/* Niveles de servicio */}
                    {(service.type.toLowerCase() === "astrologia" ||
                      service.type.toLowerCase() === "diseño humano") && (
                              ...
                              <div className="mt-4 space-y-3">
                                {selectedServiceLevel === "aurum" && (
                                  <div className="p-3 rounded-md bg-amber-500/10 border border-amber-500/30">
                                    ...
                                    <p className="text-xs mt-2 text-violet-300">
                                      <span className="text-amber-400">Miembros Electrum:</span> 20% de descuento en
                                ...
                                {selectedServiceLevel === "argentum" && (
                                  <div className="p-3 rounded-md bg-gray-500/10 border border-gray-400/30">
                                    ...
                                    <p className="text-xs mt-2 text-violet-300">
                                      <span className="text-gray-300">Miembros Platinum:</span> 10% de descuento en este
                                      nivel de servicio
                                    </p>
                                  </div>
                                )}
                    ...
                    <div className="flex justify-between text-sm">
                      ...
                      <span className="text-[#ffc83d] font-semibold">
                        ...
                        {typeof service.price === "number"
                          ...
                          : Number.parseFloat(service.price as string).toFixed(2)}
                      </span>
                    </div>
                  </div>
