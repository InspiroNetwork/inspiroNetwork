        ...
        <section className="relative py-20 px-4 overflow-hidden">
          ...
          <div className="container mx-auto z-10 text-center max-w-4xl relative">
            ...
            <p className="text-lg md:text-xl text-violet-300 mb-8 max-w-3xl mx-auto">
              A sanctuary of cosmic wisdom and transformation, dedicated to elevating consciousness through sacred
              geometry, astrology, and human design.
            </p>
          </div>
        </section>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
              <div>
                ...
                <p className="text-violet-300 mb-4">
                  NEO GAIAM was born from a profound spiritual awakening and a vision to create a platform where ancient
                  wisdom meets modern understanding.
                </p>
                <p className="text-violet-300 mb-4">
                  Our founder, after years of studying various esoteric traditions and experiencing firsthand the
                  transformative power of cosmic knowledge, felt called to share these teachings with the world.
                </p>
                <p className="text-violet-300">
                  The name "NEO GAIAM" represents our mission: "NEO" for a new approach to ancient wisdom, and "GAIAM"
                  honoring our connection to Earth (Gaia) and the greater universe.
                </p>
              </div>
          ...
          <div className="container mx-auto max-w-4xl">
            <div className="text-center mb-12">
              ...
              <p className="text-violet-300 max-w-3xl mx-auto">
                To guide individuals on their journey of spiritual awakening and self-discovery, providing tools and
                knowledge that bridge the gap between ancient wisdom and modern life.
              </p>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
              <div className="bg-indigo-900/50 backdrop-blur-sm rounded-xl p-6 border border-indigo-500/20">
                ...
                <p className="text-violet-300">
                  We empower individuals to understand their unique cosmic blueprint and harness their inherent
              ...
              <div className="bg-indigo-900/50 backdrop-blur-sm rounded-xl p-6 border border-indigo-500/20">
                ...
                <p className="text-violet-300">
                  Through our courses and resources, we share esoteric knowledge in a practical, accessible way that can
              ...
              <div className="bg-indigo-900/50 backdrop-blur-sm rounded-xl p-6 border border-indigo-500/20">
                ...
                <p className="text-violet-300">
                  We foster a community of like-minded individuals who support each other on their journey of spiritual
                  growth and cosmic understanding.
                </p>
              </div>
            </div>
          </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
              ...
              <div className="bg-indigo-900/30 backdrop-blur-sm rounded-xl overflow-hidden border border-indigo-500/20">
                ...
                <div className="p-6">
                  ...
                  <p className="text-violet-300 text-sm mb-4">
                    With over 15 years of experience in astrology and cosmic studies, Elena founded NEO GAIAM to share
              ...
              <div className="bg-indigo-900/30 backdrop-blur-sm rounded-xl overflow-hidden border border-indigo-500/20">
                ...
                <div className="p-6">
                  ...
                  <p className="text-violet-300 text-sm mb-4">
                    Marcus specializes in Human Design readings that help individuals understand their energetic
                    blueprint and make decisions aligned with their true nature.
                  </p>
                  <div className="flex space-x-3">
                    <a href="#" className="text-violet-300 hover:text-white">
                      <svg
              ...
              <div className="bg-indigo-900/30 backdrop-blur-sm rounded-xl overflow-hidden border border-indigo-500/20">
                ...
                <div className="p-6">
                  ...
                  <p className="text-violet-300 text-sm mb-4">
                    Sarah facilitates transformative healing sessions and retreats, combining sacred geometry principles
                    with energy work for deep spiritual transformation.
                  </p>
                  <div className="flex space-x-3">
                    <a href="#" className="text-violet-300 hover:text-white">
                      <svg
          ...
          <div className="container mx-auto max-w-4xl">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
              <div className="bg-indigo-900/50 backdrop-blur-sm rounded-xl p-6 border border-indigo-500/20">
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  className="h-10 w-10 text-[#ffc83d] mb-4"
                  fill="currentColor"
                  viewBox="0 0 24 24"
                >
                ...
                <p className="text-violet-200 italic mb-6">
                  "NEO GAIAM has transformed my understanding of myself and my place in the universe. The Human Design
                  reading was incredibly accurate and has helped me make decisions that feel right for me."
                </p>
              ...
              <div className="bg-indigo-900/50 backdrop-blur-sm rounded-xl p-6 border border-indigo-500/20">
                ...
                <p className="text-violet-200 italic mb-6">
                  "The Abundance & Cosmic Flow course completely shifted my relationship with money. I've implemented
                  the practices daily and seen remarkable changes in my financial situation within just two months."
                </p>
                <div className="flex items-center">
                  <img
          ...
          <div className="container mx-auto max-w-4xl">
            ...
            <div className="space-y-6">
              <div className="bg-indigo-900/30 backdrop-blur-sm rounded-xl p-6 border border-indigo-500/20">
                ...
                <p className="text-violet-300">
                  NEO GAIAM is a platform dedicated to sharing cosmic wisdom and spiritual teachings through online
                  courses, personalized sessions, and community events. We focus on astrology, human design, sacred
                  geometry, and various spiritual practices.
                </p>
              </div>

              <div className="bg-indigo-900/30 backdrop-blur-sm rounded-xl p-6 border border-indigo-500/20">
                <h3 className="text-xl font-montserrat font-semibold mb-3">
                  Do I need prior knowledge to take your courses?
                </h3>
                <p className="text-violet-300">
                  No prior knowledge is necessary. Our courses are designed to be accessible to beginners while also
                  providing depth for those with experience. Each course includes foundational knowledge and builds
                  progressively.
                </p>
              </div>
              ...
              <div className="bg-indigo-900/30 backdrop-blur-sm rounded-xl p-6 border border-indigo-500/20">
                ...
                <p className="text-violet-300">
                  You can book a personal session through our Services page. Select the type of session you're
                  interested in, choose an available date and time, and complete the booking process. You'll receive a
                  confirmation email with details about your session.
                </p>
              </div>

              <div className="bg-indigo-900/30 backdrop-blur-sm rounded-xl p-6 border border-indigo-500/20">
                <h3 className="text-xl font-montserrat font-semibold mb-3">
                  What is Human Design and how can it help me?
                </h3>
                <p className="text-violet-300">
                  Human Design is a system that combines ancient wisdom traditions with modern science to provide a map
                  of your energetic makeup. It helps you understand your unique decision-making strategy, strengths, and
                  potential challenges, enabling you to live more authentically.
                </p>
              </div>
            </div>
          </div>
          ...
          <div className="container mx-auto max-w-3xl relative z-10">
            <div className="bg-indigo-900/50 backdrop-blur-md rounded-xl p-8 md:p-12 border border-indigo-500/30 text-center">
              ...
              <p className="text-violet-300 mb-8">
                Connect with your higher self, unlock your cosmic potential, and transform your life with NEO GAIAM's
                courses and services.
              </p>
              <div className="flex flex-col sm:flex-row justify-center items-center gap-4">
                <Link
                  href="/courses"
                  className="px-8 py-4 bg-gradient-to-r from-indigo-600 to-violet-500 rounded-full text-white font-montserrat font-semibold hover:from-indigo-500 hover:to-violet-400 transition shadow-lg hover:shadow-xl hover-glow"
                >
                  Explore Courses
                </Link>
                <Link
                  href="/services"
                  className="px-8 py-4 bg-indigo-800/50 border border-violet-400/30 rounded-full text-white font-montserrat font-semibold hover:bg-indigo-700/70 transition shadow-lg hover:shadow-xl hover-glow"
                >
                  Book a Session
                </Link>
              </div>
