        ...
        <section className="relative py-20 px-4 overflow-hidden">
          ...
          <div className="container mx-auto z-10 text-center max-w-4xl relative">
            ...
            <p className="text-lg text-violet-300 mb-8">
              Have questions or looking for guidance? Reach out and let us know how we can assist in your cosmic
              journey.
            </p>
          </div>
        </section>
              ...
              <div>
                ...
                <div className="bg-indigo-900/30 backdrop-blur-sm rounded-xl p-6 md:p-8 border border-indigo-500/20">
                  ...
                  <div className="flex space-x-4">
                    <a
                      href="#"
                      className="w-10 h-10 rounded-full bg-indigo-600 flex items-center justify-center text-white hover:bg-indigo-500 transition"
                    >
                      <svg
                        xmlns="http://www.w3.org/2000/svg"
                        className="h-5 w-5"
            ...
            <div className="space-y-6">
              <div className="bg-indigo-900/50 backdrop-blur-sm rounded-xl p-6 border border-indigo-500/20">
                ...
                <p className="text-violet-300">
                  ...
                  please indicate this in your message subject.
                </p>
              </div>
              ...
              <div className="bg-indigo-900/50 backdrop-blur-sm rounded-xl p-6 border border-indigo-500/20">
                ...
                <p className="text-violet-300">
                  Yes! We offer 15-minute free consultations to help determine which of our services would best suit
                  your needs. Please mention "Free Consultation Request" in your message.
                </p>
              </div>
              ...
              <div className="bg-indigo-900/50 backdrop-blur-sm rounded-xl p-6 border border-indigo-500/20">
                ...
                <p className="text-violet-300">
                  Absolutely. Our online courses and virtual sessions are available worldwide. We adjust scheduling to
                  accommodate different time zones for our global community.
                </p>
              </div>
            </div>
          </div>
