      ...
      <main className="pt-20 pb-16">
        ...
        <section className="relative py-20 px-4 overflow-hidden">
          ...
          <div className="container mx-auto z-10 text-center max-w-4xl relative">
            ...
            <p className="text-lg text-violet-300 mb-8">{categoryInfo.description}</p>
            <Link href="/courses" className="inline-flex items-center text-violet-300 hover:text-white transition">
