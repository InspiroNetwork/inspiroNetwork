          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
            <div className="lg:col-span-2">
              ...
              <Tabs defaultValue="overview" className="mb-8" onValueChange={setActiveTab}>
                ...
                <TabsContent
                  value="overview"
                  className="bg-indigo-900/30 backdrop-blur-sm rounded-md p-6 mt-2 border border-indigo-500/20"
                >
                      ...
                      {course.learningOutcomes.map((outcome, index) => (
                        <li key={index} className="flex items-start">
                          <svg
                            ...
                            className="h-5 w-5 text-[#ffc83d] mr-2 mt-0.5"
                            viewBox="0 0 20 20"
                            fill="currentColor"
                          >
                            <path
                            ...
                            <ul className="space-y-2">
                              {module.lessons.map((lesson, lessonIndex) => (
                                <li key={lessonIndex} className="flex items-center">
                                  <svg
                                    xmlns="http://www.w3.org/2000/svg"
                                    className="h-5 w-5 text-violet-300 mr-2"
                                    viewBox="0 0 20 20"
                                    fill="currentColor"
                                  >
                                    <path
            ...
            <div className="lg:col-span-1">
              <div className="bg-indigo-900/30 backdrop-blur-sm rounded-lg border border-indigo-500/20 overflow-hidden sticky top-24">
                <div className="p-6">
                  ...
                  <div className="text-center text-sm text-violet-300">30-Day Money-Back Guarantee</div>
                </div>
              </div>
            </div>
          </div>
