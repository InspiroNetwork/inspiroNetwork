...
const Courses = () => {
  ...
  const filteredCourses =
    category === "all" ? courses : courses?.filter((course) => course.category.toLowerCase() === category.toLowerCase())
        ...
        <section className="relative py-20 px-4 overflow-hidden">
          ...
          <div className="container mx-auto z-10 text-center max-w-4xl relative">
            ...
            <p className="text-lg text-violet-300 mb-8">
              Explore our transformative courses designed to elevate your consciousness and connect you with universal
              wisdom.
            </p>
          </div>
        </section>
