        ...
        <section className="relative py-20 px-4 overflow-hidden">
          ...
          <div className="container mx-auto z-10 text-center max-w-4xl relative">
            ...
            <p className="text-lg text-violet-300 mb-8">
              Discover upcoming courses, workshops, and spiritual retreats to elevate your consciousness and connect
            ...
            {view === "calendar" && (
              <div className="mb-12">
                <div className="flex items-center justify-between mb-4">
                  ...
                  <h2 className="text-xl font-montserrat font-semibold">{format(date, "MMMM yyyy")}</h2>
                  <Button
                    variant="outline"
                ...
                {isLoading ? (
                  ...
                  Array(3)
                    ...
                    .map((_, i) => (
                      <div
                        key={i}
                        className="bg-indigo-900/30 backdrop-blur-sm rounded-xl p-6 shadow-lg border border-indigo-500/20"
                      >
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 items-center">
              ...
              <div>
                ...
                <h3 className="text-2xl md:text-3xl font-montserrat font-bold mb-4">
                  Cosmic Retreat: Sedona Energy Vortex
                </h3>
                <p className="text-violet-300 mb-6">
                  A 5-day immersive spiritual retreat in Sedona's powerful energy vortexes, combining meditation,
                  astrology, and sacred geometry. Connect with like-minded souls in this transformative journey.
                </p>
