                ...
                <div className="flex space-x-1">
                  <button
                    ...
                    className={`px-6 py-2 rounded-full text-sm font-medium transition ${
                      billingInterval === "monthly" ? "bg-indigo-600 text-white" : "text-violet-300 hover:text-white"
                    }`}
                  >
                    Mensual
                  </button>
                  <button
                    ...
                    className={`px-6 py-2 rounded-full text-sm font-medium transition ${
                      billingInterval === "annual" ? "bg-indigo-600 text-white" : "text-violet-300 hover:text-white"
                    }`}
                  >
                    Anual
              ...
              {membershipPlans?.map((plan) => (
                <div
                  ...
                  className={`
                    ...
                    ${plan.level === "electrum" ? "border-amber-500/50 ring-2 ring-amber-500/20" : "border-gray-500/30"}
                  `}
                >
                  <div className="flex items-center justify-between mb-6">
                    <h3 className="text-2xl font-montserrat font-bold">{plan.name}</h3>
                    {plan.level === "electrum" && <Badge className="bg-amber-500 hover:bg-amber-600">Premium</Badge>}
                  </div>
                    ...
                    <div className="flex items-end">
                      <span className="text-4xl font-bold">
                        ...
                        {billingInterval === "monthly"
                          ? Number.parseFloat(plan.monthlyPrice).toFixed(2)
                          : Number.parseFloat(plan.annualPrice).toFixed(2)}
                      </span>
                  ...
                  <p className="text-center text-xs text-violet-300 mt-4">Puedes cancelar en cualquier momento</p>
                </div>
              ))}
            </div>
          )}
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mb-10">
              <div className="bg-indigo-800/30 rounded-lg p-6 border border-amber-500/30">
                ...
                <div className="mt-4 text-sm text-violet-300">
                  <span className="font-semibold text-amber-400">Miembros Electrum:</span> 20% de descuento en sesiones
                  Aurum
                </div>
              </div>
              ...
              <div className="bg-indigo-800/30 rounded-lg p-6 border border-gray-400/30">
                ...
                <div className="mt-4 text-sm text-violet-300">
                  <span className="font-semibold text-gray-300">Miembros Platinum:</span> 10% de descuento en sesiones
                  Argentum
                </div>
              </div>
            </div>
            ...
            <div className="space-y-6">
              <div>
                ...
                <p className="text-violet-300">
                  Al suscribirte a uno de nuestros planes, obtendrás acceso a beneficios exclusivos como descuentos en
                  servicios, contenido premium y sesiones especiales. Puedes elegir entre un plan mensual o anual con la
              ...
              <div>
                ...
                <p className="text-violet-300">
                  El plan Electrum ofrece todos los beneficios premium, incluyendo un 20% de descuento en todas las
                  sesiones y acceso a sesiones exclusivas de nivel Aurum. El plan Platinum ofrece un 10% de descuento en
                  sesiones de nivel Argentum y beneficios básicos.
                </p>
              </div>
              ...
              <div>
                ...
                <p className="text-violet-300">
                  Sí, puedes actualizar o cambiar tu plan en cualquier momento desde tu perfil. Si decides actualizar de
                  Platinum a Electrum, el cambio se aplicará inmediatamente y se te cobrará la diferencia prorrateada.
                </p>
              </div>
              ...
              <div>
                ...
                <p className="text-violet-300">
                  Los descuentos se aplican automáticamente cuando reservas cualquier servicio estando registrado con tu
                  cuenta de miembro. Verás el precio con descuento aplicado directamente en la página de reserva.
                </p>
              </div>
            </div>
          </div>
