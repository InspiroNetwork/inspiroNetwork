              ...
              {isLoading ? (
                ...
                Array(6)
                  ...
                  .map((_, i) => (
                    <div
                      key={i}
                      className="bg-indigo-900/30 backdrop-blur-sm rounded-xl overflow-hidden shadow-lg border border-indigo-500/20"
                    >
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 items-center">
              ...
              <div>
                ...
                <h3 className="text-2xl md:text-3xl font-montserrat font-bold mb-4">
                  The Lyra Constellation: Your Cosmic Origins
                </h3>
                <p className="text-violet-300 mb-6">
                  Explore the ancient wisdom connecting human consciousness to the Lyra star system and what it means
                  for your spiritual journey. Discover how this distant constellation holds the keys to understanding
                  your soul's purpose.
                </p>
