...
const CourseCubeSection: React.FC = () => {
  ...
  return (
    <section
      id="courses"
      className="relative py-20 px-4 min-h-screen flex flex-col items-center justify-center overflow-hidden"
    >
      ...
      <div className="container mx-auto z-10 text-center mb-12">
        ...
        <p className="text-lg max-w-2xl mx-auto text-violet-300">
          Explore our cosmic courses organized by the six vertices of the Metatron's Cube, each representing a
      ...
      <div className="cube-container w-full max-w-3xl mx-auto mb-16 relative h-[500px] md:h-[600px]">
        ...
        <MetatronCube vertices={courseVertices} size={500} woodenStyle={true} rotationSpeed={0.0005} />
      </div>
          ...
          ? // Loading skeleton
            Array(3)
              ...
              .map((_, i) => (
                <div
                  key={i}
                  className="bg-indigo-900/50 backdrop-blur-sm rounded-xl overflow-hidden shadow-lg border border-indigo-500/30"
                >
      ...
      <div className="mt-12 text-center">
        <Link
          href="/courses"
          className="inline-flex items-center px-6 py-3 bg-indigo-800/50 border border-indigo-400/30 rounded-full text-white font-montserrat font-medium hover:bg-indigo-700/70 transition shadow-lg hover:shadow-xl hover-glow"
        >
          View All Courses
