    ...
    >
      ...
      <div className="container mx-auto z-10 text-center">
        ...
        <p className="text-lg md:text-xl max-w-2xl mx-auto text-violet-300 mb-10">
          Explore the depths of your soul and the heights of your potential through sacred geometry, astrology, and
          human design.
        </p>
        ...
        <div className="flex flex-col md:flex-row items-center justify-center gap-6 mt-8">
          ...
          <Link
            href="/services"
            className="px-8 py-4 bg-gradient-to-r from-indigo-800/50 to-violet-700/50 backdrop-blur-sm border border-violet-400/30 rounded-full text-white font-montserrat font-semibold hover:bg-indigo-700/70 transition shadow-lg hover:shadow-xl hover-glow"
          >
            Book a Session
          </Link>
        </div>
