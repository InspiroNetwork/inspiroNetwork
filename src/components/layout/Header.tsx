  ...
  return (
    ...
    >
      <div className="container mx-auto px-4 flex justify-between items-center">
        <Link
          href="/"
          className="text-2xl md:text-3xl font-montserrat font-bold tracking-wider text-white flex items-center"
        >
        ...
        <nav className="hidden md:flex items-center space-x-8">
          ...
          <Link
            href="/login"
            className="px-4 py-2 rounded-full bg-indigo-600 hover:bg-indigo-500 transition text-white"
          >
            Login
          </Link>
          <LanguageSwitcher />
      ...
      {isMenuOpen && (
        <div className="md:hidden bg-indigo-800 w-full">
          <div className="container mx-auto px-4 py-3 flex flex-col space-y-3">
            ...
            <Link
              href="/login"
              className="py-2 px-4 rounded-full bg-indigo-600 hover:bg-indigo-500 transition text-center text-white"
            >
              Login
            </Link>
...
const NavLink = ({ href, label, currentPath, onClick }: NavLinkProps) => {
  ...
  return (
    <Link
      ...
      onClick={onClick}
      className={`${
        isActive ? "text-[#8a4fff] font-medium" : "text-white hover:text-[#ffc83d]"
