  ...
  return (
    <div className={`relative ${className}`} style={{ width: size, height: size, opacity }}>
      ...
      >
        ...
        {/* Glowing background */}
        <circle cx={centerX} cy={centerY} r={radius * 4} fill="url(#flowerGlow)" className="animate-pulse-slow" />
            ...
            style={{
              animation:
                i === 0
                  ? `pulse 6s infinite`
                  : i < 7
                    ? `twinkle ${animationDuration}s ease-in-out ${i * 0.5}s infinite alternate`
                    : undefined,
            }}
          />
        ))}
